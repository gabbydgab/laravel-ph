...
<div class="max-w-3xl mx-auto px-4">
    ...
    <div class="flex items-end justify-between mt-6">
        <div class="flex items-center">
            ...
            <div class="ml-4 leading-tight">
                ...
                <div class="text-gray-600" v-cloak>{{ $article->published_at->diffForHumans() }}</div>
            </div>
        </div>
        ...
        <form action="{{ route('articles.show', $article) . '/likes' }}" method="POST">
            @csrf
            <div class="flex items-center">
                <span class="text-gray-600 font-medium mr-2">@include('articles.likes-count')</span>
    ...
    <h1 class="text-3xl font-semibold leading-none tracking-tight mt-10">{{ $article->title }}</h1>
